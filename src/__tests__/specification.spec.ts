...
describe("Specification", () => {
  ...
  it("should support multiple chains", () => {
    ...
    expect(spec1.isSatisfiedBy(4)).resolves.toBe(false);
    expect(spec1.isSatisfiedBy(6)).resolves.toBe(true);
    expect(spec1.isSatisfiedBy(9)).resolves.toBe(false);
    expect(spec2.isSatisfiedBy(4)).resolves.toBe(true);
    expect(spec2.isSatisfiedBy(5)).resolves.toBe(true);
    expect(spec2.isSatisfiedBy(1)).resolves.toBe(false);
    expect(spec2.isSatisfiedBy(9)).resolves.toBe(false);
    expect(spec3.isSatisfiedBy(1)).resolves.toBe(false);
    expect(spec3.isSatisfiedBy(5)).resolves.toBe(false);
    expect(spec3.isSatisfiedBy(9)).resolves.toBe(false);
    expect(spec3.isSatisfiedBy(10)).resolves.toBe(true);
    expect(spec4.isSatisfiedBy(1)).resolves.toBe(false);
    expect(spec4.isSatisfiedBy(5)).resolves.toBe(false);
    expect(spec4.isSatisfiedBy(6)).resolves.toBe(true);
    expect(spec4.isSatisfiedBy(9)).resolves.toBe(true);
    expect(spec4.isSatisfiedBy(10)).resolves.toBe(true);
  });
});
